...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-cente font-prompt">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl p-4">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <h3 className="text-lg font-semibold mb-4">
            ยอดเงินคงเหลือ: <span className="text-rose-700">{price} บาท</span>
          </h3>
          ...
          <button
            ...
            className="bg-blue-900 text-white w-full py-2 rounded-lg"
          >
            ถอนเงิน
          </button>
        </div>
